...
const translations = {
    en: {
        ...
        shadowLounge: 'The Tatami Room',
        shadowCapacity: 'Capacity: 4-6 Players',
        shadowLoungeDesc: 'A serene Japanese-inspired space with low tatami seating and a traditional table. Warm lantern light and minimalist decor create an intimate, contemplative atmosphere perfect for tales of honor, secrets, and quiet suspense.',
    ...
    zh: {
        ...
        shadowLounge: '榻榻米房',
        shadowCapacity: '容量：4-6名玩家',
        shadowLoungeDesc: '一个宁静的日式风格空间，配有低矮的榻榻米座席和传统矮桌。温暖的灯笼光线与极简装饰，营造出亲密而沉静的氛围，非常适合关于荣誉、秘密与静谧悬疑的故事。',
